...
public class BrideEngineException extends Exception {
	...
	public BrideEngineException(Throwable t) {
		super("rc." + ENGINE_UNKNOWN_ERROR, t);
		this.errorCode = ENGINE_UNKNOWN_ERROR;
		this.info = new String[] { t.getMessage() };
	}
	
	public BrideEngineException(int errorCode) {
		super("rc." + errorCode);
		this.errorCode = errorCode;
	}
	
	public BrideEngineException(int errorCode, String[] info) {
