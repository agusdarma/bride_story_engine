...
public class MessageUtils {
	...
	public static String handleException(Exception e,String otherMessage,ObjectMapper mapper) {
		...
		try {			
			...
			if (e instanceof BrideEngineException) {
				BrideEngineException jme = (BrideEngineException) e;
				if(jme.hasInfo()){
				...
				messageVO.setRc(BrideEngineException.ENGINE_UNKNOWN_ERROR);
				messageVO.setMessageRc(props.getProperty("rc."+BrideEngineException.ENGINE_UNKNOWN_ERROR));
